...
describe('MCP Client Integration Tests', () => {
	...
	describe('Full MCP Protocol Flow', () => {
		...
		it('should allow authenticated access to all features', async () => {
			...
			expect(toolsList.result.tools).toHaveLength(10) // ping, server_info, auth_status, search_collection, get_release, get_collection_stats, get_recommendations, get_cache_stats, get_recent_activity, get_collection_gaps
